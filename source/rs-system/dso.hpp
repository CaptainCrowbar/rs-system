...
namespace RS::System {
    ...
    public:
        ...
        Dso() = default;
        explicit Dso(const IO::Path& file, flag_type flags = default_flags) { load_library(file, flags, true); }
        ~Dso() noexcept { reset(); }
        ...
        IO::Path file() const { return file_; }
        ...
        static Dso self(flag_type flags = default_flags) { return Dso(IO::Path(), flags); }
    ...
    private:
        ...
        bool load_library(const IO::Path& file, flag_type flags, bool check);
